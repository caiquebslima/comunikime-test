function IconWeChat() {
  return (
    ...
    >
      <path
        style={{ fill: '#FAFAFA' }}
        d='M365.397,156.629C341.568,88.448,269.739,42.667,186.667,42.667C83.733,42.667,0,114.432,0,202.667
	...
	c3.467-0.034,6.724-1.663,8.832-4.416C366.014,163.573,366.548,159.924,365.397,156.629z'
      ...
      <g>
        <path
          style={{ fill: '#4CAF50' }}
          d='M117.333,106.667c-17.673,0-32,14.327-32,32s14.327,32,32,32s32-14.327,32-32
		S135.006,106.667,117.333,106.667z'
        />
        <path
          style={{ fill: '#4CAF50' }}
          d='M245.333,106.667c-17.673,0-32,14.327-32,32s14.327,32,32,32s32-14.327,32-32
		S263.006,106.667,245.333,106.667z'
        />
      </g>
      <path
        style={{ fill: '#FAFAFA' }}
        d='M512,320c0-70.592-71.765-128-160-128s-160,57.408-160,128s71.765,128,160,128
	...
	l-14.485-36.267C488.763,397.446,510.505,360.455,512,320z'
      ...
      <g>
        <path
          style={{ fill: '#4CAF50' }}
          d='M298.667,256c-11.782,0-21.333,9.551-21.333,21.333c0,11.782,9.551,21.333,21.333,21.333
		c11.782,0,21.333-9.551,21.333-21.333C320,265.551,310.449,256,298.667,256z'
        />
        <path
          style={{ fill: '#4CAF50' }}
          d='M405.333,256C393.551,256,384,265.551,384,277.333c0,11.782,9.551,21.333,21.333,21.333
